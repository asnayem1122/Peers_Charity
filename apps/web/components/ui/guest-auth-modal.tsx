  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fade-in">
      <div className="relative w-full max-w-md p-6 sm:p-8 rounded-3xl bg-card border border-border shadow-2xl space-y-6 text-center font-sans">
        ...
        <div className="p-3.5 rounded-2xl bg-muted/60 border border-border text-xs font-mono text-left space-y-1">
          <p className="font-bold text-foreground">Demo Accounts:</p>
          <p className="text-muted-foreground">
            <span className="font-semibold text-foreground">Student:</span> nayem@student.university.edu
          </p>
          <p className="text-muted-foreground">
