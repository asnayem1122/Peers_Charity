        ...
        <div className="p-12 rounded-3xl bg-card border border-border shadow-sm text-center space-y-4 font-mono">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-muted-foreground max-w-md mx-auto font-sans">
              {searchQuery
                ? `No materials match your search "${searchQuery}" or active filters.`
                : 'The Charity Bazaar is ready for contributions. Be the first student to donate study materials!'}
            </p>
          </div>
          <Link
            href="/donate"
