      ...
      {examPackFilter.length === 0 ? (
        <div className="p-12 rounded-3xl bg-card border border-border shadow-sm text-center space-y-4 font-mono">
          ...
          <div className="space-y-1">
            <h3 className="text-lg font-bold text-foreground uppercase">No High-Yield Exam Packs Yet</h3>
            <p className="text-xs text-muted-foreground max-w-md mx-auto font-sans">
              No emergency review materials or past question papers have been uploaded yet for this course filter. Be a semester savior and upload your notes!
            </p>
          </div>
          <Link
            href="/donate"
